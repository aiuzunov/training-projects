				...
				<?php if ( $this->show_title ) { ?>
					<h1>
						...
						<a
								...
								onclick="javascript:window.location.href='?page=<?php echo esc_attr( $this->page ); ?><?php echo '' === $this->schema_name ? '' : '&schema_name=' . esc_attr( $this->schema_name ); ?>&table_name=<?php echo esc_attr( $this->table_name ); ?><?php echo esc_attr( $add_param ); ?><?php echo $this->page_number_link; ?>'"
						...
						if ( null !== $this->help_url ) {
							?>
							<a href="<?php echo $this->help_url; ?>" target="_blank" title="Plugin Help - open a new tab or window">
				...
				<form id="<?php echo esc_attr( $this->current_form_id ); ?>"
					...
					<?php if ( 'view' !== $this->action ) { ?>
						...
						<?php if ( $this->show_back_button ) { ?>
							<input type="button"
								   onclick="javascript:window.location.href='?page=<?php echo esc_attr( $this->page ); ?><?php echo '' === $this->schema_name ? '' : '&schema_name=' . esc_attr( $this->schema_name ); ?>&table_name=<?php echo esc_attr( $this->table_name ); ?><?php echo esc_attr( $this->add_parent_args_to_back_button() ); ?><?php echo esc_attr( $add_param ); ?><?php echo $this->page_number_link; ?>'"
