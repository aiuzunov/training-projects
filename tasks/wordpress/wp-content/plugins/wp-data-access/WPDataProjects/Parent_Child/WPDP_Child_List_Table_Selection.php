	...
	class WPDP_Child_List_Table_Selection extends WPDP_Child_List_Table {
		...
		public function show() {
			...
			<div style="padding-top:5px;padding-left:3px;">
				<input type="button"
					   onclick="javascript:window.location.href='?page=<?php echo esc_attr( $this->page ); ?><?php echo '' === $this->schema_name ? '' : '&schema_name=' . esc_attr( $this->schema_name ); ?>&table_name=<?php echo esc_attr( $this->table_name ); ?><?php echo esc_attr( $this->add_parent_args_to_back_button() ); ?><?php echo $this->page_number_link; ?>'"
