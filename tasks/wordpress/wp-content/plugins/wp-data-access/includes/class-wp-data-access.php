...
class WP_Data_Access {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_action_wpda_save_csv_mapping', WPDA_CSV_Uploads_Model::class, 'save_mapping' );
		$this->loader->add_action( 'admin_action_wpda_csv_preview_mapping', WPDA_CSV_Uploads_Model::class, 'preview_mapping' );
	}
