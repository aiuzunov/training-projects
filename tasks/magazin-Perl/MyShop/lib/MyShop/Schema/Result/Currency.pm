use utf8;
package MyShop::Schema::Result::Currency;
...
=head2 C<currencies_currency_id_key>
...
__PACKAGE__->add_unique_constraint("currencies_currency_id_key", ["currency_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uPSUnWJcKgxl+OYqcW1ycw
